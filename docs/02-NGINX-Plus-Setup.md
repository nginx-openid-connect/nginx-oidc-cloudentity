# How To Set Up NGINX Plus OIDC for Cloudentity Integration (WIP)
...
1. Clone the [nginx-openid-connect/nginx-oidc-cloudentity](git@github.com:nginx-openid-connect/nginx-oidc-v1-cloudentity.git) GitHub repository, or download the repo files.

   ```bash
   git clone https://github.com/nginx-openid-connect/nginx-oidc-cloudentity.git
   ```
