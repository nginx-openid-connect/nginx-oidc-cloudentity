# nginx-oidc-cloudentity (WIP)

Reference implementation of NGINX Plus as relying party for OpenID Connect authentication w/ Cloudentity.

This repo provides the information of how to set up Cloudentity, integrate with NGINX Plus, and locally test using a containerized NGINX Plus app, a frontend OIDC simulation tool, and a NGINX Dev Portal.
...
- [Create and configure an app in Cloudentity](./docs/01-IdP-Setup.md)
...
- [Troubleshooting for NGINX Plus OIDC and Cloudentity](https://github.com/nginx-openid-connect/nginx-oidc-troubleshooting#-troubleshooting-for-nginx-plus-oidc-and-cloudentity)
...
- [NGINX Plus: Single Sign-On With Cloudentity](https://docs.nginx.com/nginx/deployment-guides/single-sign-on/cognito/)
